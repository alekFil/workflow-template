...
Полная архитектура: `docs/blueprint.md`
...
| Текущая задача | `docs/plan.md` |
| Архитектурные решения | `docs/decisions.md` |

В начале каждой сессии читай: `docs/blueprint.md` → `docs/to-do.md` → `docs/status.md`.
Перед реализацией дополнительно: `docs/plan.md`.
...
- По итогу обсуждения пишешь план в `docs/plan.md` (формат ниже)
