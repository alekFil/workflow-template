...
| ------------------------ | ----------- | ------------------------------------------------------ |
| `организуем работу`      | Организатор | Обсуждение процессов, правка `docs/index.md` и скиллов |
...
| `начинаем реализацию`    | Разработчик | Читает `docs/plan.md`, создаёт ветку, пишет код        |
| `записываем решение`     | —           | Добавляет ADR в `docs/decisions.md`                    |
...
0. Начало сессии — CC читает автоматически:
   docs/blueprint.md → docs/to-do.md → docs/status.md
...
2. Обсуждение
   → "обсудим задачу"
   CC задаёт вопросы, фиксирует решения, пишет docs/plan.md
...
| `docs/blueprint.md` | Архитектура проекта |
| `docs/to-do.md` | Очередь задач |
| `docs/plan.md` | Текущая задача |
| `docs/status.md` | Актуальное состояние реализации |
